...
<p align='center'>
<img src='./images/gephisto_degree.png'>
</p>
...
The second visualization was done using the file [community.graphml](./files_graph_files) in which it divides the network according to the community of the nodes. Also, to improve the visualization, only nodes with a degree greater than or equal to 4 were kept. The image below shows the result of the visualization.
